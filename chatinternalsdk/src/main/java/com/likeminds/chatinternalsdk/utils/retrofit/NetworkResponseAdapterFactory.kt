...
internal class NetworkResponseAdapterFactory(private val gson: Gson) : CallAdapter.Factory() {
    ...
    override fun get(
        ...
        return NetworkResponseAdapter<Any>(gson, successBodyType, errorBodyConverter)
    }
